...
void doneCallback (const actionlib::SimpleClientGoalState& state, const Action_Server::path_msgResultConstPtr& result) {
    ...
    bool isSuccessful = result->result;
...
int main(int argc, char** argv) {
        ros::init(argc, argv, "path_msg_action_client"); // name this node 
        ros::NodeHandle nh;
        ...
        actionlib::SimpleActionClient<Action_Server::path_msg.action> action_client("path_msg_action", true);
